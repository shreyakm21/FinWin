    ...
    <div className="gt-modal-backdrop">
      <div className="gt-modal">
        ...
        <div className="gt-violations">
          {violations.map(v => (
            <div key={v.goalId} className="gt-violation-card">
              ...
              <p className="gt-exceeded">
                Exceeded by ₹{v.exceededBy}
              </p>
            </div>
          ))}
        </div>
        ...
        <div className="gt-modal-actions">
          <button className="transaction-btn-secondary" onClick={onCancel}>
            Cancel Payment
          </button>
          <button className="transaction-btn-primary" onClick={onProceed}>
            Proceed Anyway
          </button>
        </div>
      </div>
